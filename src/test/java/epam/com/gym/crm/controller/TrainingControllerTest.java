...
class TrainingControllerTest {
    ...
    void addTraining_shouldReturn200_whenRequestIsValid() throws Exception {
        ...
        when(gymFacade.createTraining(any(TrainingCreateRequest.class)))
    ...
    void getTraineeTrainings_shouldReturn200AndList_whenUsingFilters() throws Exception {
        ...
        when(gymFacade.getTraineeTrainingsByCriteria(any(TraineeTrainingFilter.class)))
                .thenReturn(List.of(mockTraining));

        when(trainingMapper.mapTraineeTrainings(anyList()))
        ...
        verify(gymFacade).getTraineeTrainingsByCriteria(any(TraineeTrainingFilter.class));
    }
    ...
    void getTrainerTrainings_shouldReturn200AndList_whenUsingFilters() throws Exception {
        ...
        when(gymFacade.getTrainerTrainingsByCriteria(any(TrainerTrainingFilter.class)))
                .thenReturn(List.of(mockTraining));

        when(trainingMapper.mapTrainerTrainings(anyList()))
                .thenReturn(expectedResponse);
        ...
        verify(gymFacade).getTrainerTrainingsByCriteria(any(TrainerTrainingFilter.class));
    }
